...
namespace kmint
{
	namespace ufo {
		...
		public:
			...
			inline void  Rotate(const math::vector2d& fwd, const math::vector2d& side);

			//applys a transformation matrix to a std::vector of points
			inline void TransformVector2Ds(std::vector<math::vector2d>& vPoints);

			//applys a transformation matrix to a point
			inline void TransformVector2Ds(math::vector2d& vPoint);
		...
		inline void C2DMatrix::TransformVector2Ds(std::vector<math::vector2d>& vPoint)
		{
		...
		//applies a 2D transformation matrix to a single math::vector2d
		inline void C2DMatrix::TransformVector2Ds(math::vector2d& vPoint)
		{
		...
		inline void C2DMatrix::Rotate(const math::vector2d& fwd, const math::vector2d& side)
		{
			C2DMatrix::Matrix mat;
